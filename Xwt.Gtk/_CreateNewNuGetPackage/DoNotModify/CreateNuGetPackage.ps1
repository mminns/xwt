...
function Ensure-AssemblyFileExistsWhereNuGetExpectsItToBe([string]$ProjectFilePath, [string]$OutputDirectory, [string]$Configuration, [string]$Platform)
{
	...
	Write-Output "projectFilePropertyGroups =[$projectFilePropertyGroups]"
	...
	Write-Output "projectFilePropertyGroupForCurrentConfigurationAndPlatform =[$projectFilePropertyGroupForCurrentConfigurationAndPlatform]"
	...
	Write-Output "projectFileOutputDirectory =[$projectFileOutputDirectory]"
